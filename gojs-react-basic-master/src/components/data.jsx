export default {
    data: [
                ...
                Content: {
                    Config: {
                        ...
                        Equipments: {
                            ...
                            EntryHandler_Bash: {
                                Program: "{{DIR_SCRIPTS}}/entry_handler.sh {{SN}} {{BT_MAC}} {{ETH_MAC}}",
                                TimeoutInSec: 10,
                            },
                            ExitHandler_Bash: {
        ...
        },
        {
            ...
            Location: "core",
            Descriptor: {
                Content: '2019-03-31 08: 43: 16 ERROR  : Error connecting to the server: definition of service "localservice" not found\r\n\r\nkkljglgjlkj',
